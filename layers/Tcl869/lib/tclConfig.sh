...
TCL_EXTRA_CFLAGS='-O3 -march=native -pipe -m64 '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/ec2-user/build/tcl8.6.9 -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/tmp/opt/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/tmp/opt/include'
...
# compiled.
TCL_SRC_DIR='/home/ec2-user/tcl8.6.9'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/tmp/opt/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/ec2-user/build/tcl8.6.9 -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/tmp/opt/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/ec2-user/build/tcl8.6.9/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/tmp/opt/lib/libtclstub8.6.a'
